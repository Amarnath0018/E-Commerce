...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Query to fetch data
    $sql = "SELECT name, email, id, phone_number, role FROM user_details LIMIT $start_from, $records_per_page";
    $result = $connect->query($sql);

    // Fetch total number of records for pagination
    $total_sql = "SELECT COUNT(*) FROM user_details";
